            ...
            <div className="space-y-16">
              {workExperiences.map((exp, index) => (
                ...
                >
                  ...
                  {/* Circle Node Marker */}
                  <div className={`absolute -left-[25px] sm:-left-[29px] top-2 w-3 h-3 rounded-none border z-10 transition-transform hover:scale-125 duration-300 timeline-dot-pulse ${isDark ? 'bg-white border-black' : 'bg-black border-white'}`}></div>
